...
<div class="table-wrap" ref="tableWrap">
  <div class="ms-table-header" ref="tableHead" :style="style" v-if="columns.length" >
    <table cellspacing="0" cellpadding="0">
      <thead class="table_thead">
        <tr>
          ...
          <th class="table_cell" v-if="actions">
            <div>
              <span>操作</span>
            </div>
          </th>
...
export default {
  ...
  methods: {
    ...
    computedStyle () {
      ...
      let maxWidth = (arr[0] - mainW) > 180 ? arr[0] + 'px' : main
      this.style = {
        width: maxWidth
      }
      if (this.height) {
